...
:: Find the thirteen adjacent digits in the 1000-digit number with the greatest product.

SET _long=73167176531330624919225119674426574742355349194934
SET _long=%_long%96983520312774506326239578318016984801869478851843
SET _long=%_long%85861560789112949495459501737958331952853208805511
SET _long=%_long%12540698747158523863050715693290963295227443043557
SET _long=%_long%66896648950445244523161731856403098711121722383113
SET _long=%_long%62229893423380308135336276614282806444486645238749
SET _long=%_long%30358907296290491560440772390713810515859307960866
SET _long=%_long%70172427121883998797908792274921901699720888093776
SET _long=%_long%65727333001053367881220235421809751254540594752243
SET _long=%_long%52584907711670556013604839586446706324415722155397
SET _long=%_long%53697817977846174064955149290862569321978468622482
SET _long=%_long%83972241375657056057490261407972968652414535100474
SET _long=%_long%82166370484403199890008895243450658541227588666881
SET _long=%_long%16427171479924442928230863465674813919123162824586
SET _long=%_long%17866458359124566529476545682848912883142607690042
SET _long=%_long%24219022671055626321111109370544217506941658960408
SET _long=%_long%07198403850962455444362981230987879927244284909188
SET _long=%_long%84580156166097919133875499200524063689912560717606
SET _long=%_long%05886116467109405077541002256983155200055935729725
SET _long=%_long%71636269561882670428252483600823257530420752963450
...
FOR /L %%G IN (0,1,988) DO (
	CALL SET _substr=%%_long:~%%G,%_13%%%
	IF /I "!_substr:0=!"=="!_substr!" (
		SET _res=1
		FOR /L %%H IN (0,1,12) DO (
			CALL SET _num=%%_substr:~%%H,1%%
			CALL :ExtMultiply !_res! !_num! _res
		)
		CALL :ExtCompare !_res! !_high! _comp
		IF "!_comp!"=="GTR" SET _high=!_res!
		ECHO:!_high!
	) 
)
